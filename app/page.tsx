...
export default function Home() {
  ...
  async function createSession() {
    ...
    const { error } = await supabase.from('sessions').insert({ id, films: [], film_list: films })
  ...
  return (
    <main className="min-h-screen p-8 max-w-md mx-auto">
      ...
      <button
        ...
        disabled={loading}
        className="w-full bg-purple-700 text-white px-6 py-3 rounded-xl font-medium mb-3 disabled:opacity-50"
      >
